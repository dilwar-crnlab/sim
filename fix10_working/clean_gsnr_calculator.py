    ...
    def calculate_gsnr(self, path_links: List, channel_index: int, core_index: int,
        ...
        for link in path_links:
            ...
            for span_idx in range(link.num_spans):
                ...
                # Step 1: Use existing power evolution for this span with link-specific interference
                span_step1_result = self._step1_power_evolution(
                    single_span_links, channel_index, link_interfering_channels, launch_power_dbm
                )
